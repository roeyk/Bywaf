...
def parse_note_selectors(args: list[str], *, allow_text: bool) -> dict[str, str]:
    ...
    selectors = parse_key_value_tokens(args, allowed_keys=NOTE_SELECTOR_KEYS, command="note", text_keys=text_keys)
...
def validate_note_selectors(selectors: dict[str, str], *, allow_text: bool) -> None:
    ...
    require_exactly_one_selector(selectors, NOTE_SCOPE_KEYS, command="note")
