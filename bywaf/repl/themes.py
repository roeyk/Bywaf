...
THEME_PRESETS: dict[str, dict[str, str]] = {
    ...
    "classic": {
        ...
        "display/style.artifact": "color39",
        "display/style.event": "color39",
        "display/style.hash": "color245",
