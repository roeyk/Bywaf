...
try:  # noqa: E402
    from plugin_catalog_manifest import (
        bool_value,
        catalog_event_schema_entries,
        optional_string,
        required_string,
        string_list_value,
        table_value,
    )
except ModuleNotFoundError:  # pragma: no cover - used when imported as scripts.plugin_catalog
    from scripts.plugin_catalog_manifest import (
        bool_value,
        catalog_event_schema_entries,
        optional_string,
        required_string,
