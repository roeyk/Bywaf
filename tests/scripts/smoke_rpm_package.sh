...
cp "$WORKDIR/dist/bywaf-0.9.0.tar.gz" "$WORKDIR/rpmbuild/SOURCES/"
...
test -f "$WORKDIR/rpmbuild/RPMS/noarch/bywaf-0.9.0-1.noarch.rpm"
test -f "$WORKDIR/rpmbuild/SRPMS/bywaf-0.9.0-1.src.rpm"
